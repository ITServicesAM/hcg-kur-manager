...
public class HistoryActivity extends BaseNavDrawerActivity implements
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        recyclerViewAdapter.notifyDataSetChanged();
                        // this must be done to update the day title and we wait for the animation to finish!
                    }
                });
            }
        }, 400);
